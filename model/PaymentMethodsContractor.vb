Public Module PaymentMethodsContractor

    Private Const ID_GENKIN As String = "0"
    Private Const ID_FURIKOMI As String = "1"
    Private Const ID_KOGITTE As String = "2"
    Private Const ID_TEGATA As String = "3" ' 請求書の支払方法とは手形と相殺のIDが逆のため注意
    Private Const ID_SOUSAI As String = "4" ' 請求書の支払方法とは手形と相殺のIDが逆のため注意
